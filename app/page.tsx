...
import MarkdownLessons from "./components/MarkdownLessons";

export default function Home() {
  return (
   <div className="w-screen max-w-full min-h-fit overflow-x-hidden bg-gradient-to-br from-blue-400 via-slate-600 to-gray-100 bg-[length:400%_400%] animate-gradient">
